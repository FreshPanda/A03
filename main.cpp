...
int main(int argc, char* argv[])
{
   ...
   Tournament newTourn;
    do
    {
       ...
       {
           Player * newAdv = new RandomComputer();
           newTourn.addPlayers(newAdv);
       }
    } while (computerStream); // While not reached the end of stringstream
    
    cout << newTourn.print_scores();
}
//Sample inputs: Avalanche Bureaucrat Bureaucrat Toolbox Toolbox Crescendo Crescendo Fistful-lODollars
